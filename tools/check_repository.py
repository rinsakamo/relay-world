...
REQUIRED_PATHS = [
    ...
    "src/relay_world/observation.py",
    "src/relay_world/intervention.py",
    "tests/test_package_bootstrap.py",
    "tests/test_world_observation.py",
    "tests/test_experiment_intervention.py",
    "docs/ontology.md",
    "docs/architecture.md",
    "docs/contracts/world-observation.md",
    "docs/contracts/experiment-intervention.md",
